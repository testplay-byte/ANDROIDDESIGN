# ONLYLIST — AI-Powered Design System for Android
...
```
repo-root/
├── ONLYLIST/                     ← the single wrapper folder
...
**Start here:** `ONLYLIST/AGENT-CONTEXT/memory/progress.md` — tells you where the project is.
...
TBD — pending user decision. The project itself is currently private (repo `testplay-byte/ONLYLIST`). Third-party attributions (Cline Apache 2.0, OFL fonts, etc.) will be listed in `APP/ani-design/DOCUMENTATION/licenses/` once the app is built.
