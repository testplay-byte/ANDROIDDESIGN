...
**Recommended posture for ANDROIDDESIGN:** Treat Cline as **architectural inspiration only** —
...
server on their own machine (or any cloud) and point ANDROIDDESIGN at it for custom tools
